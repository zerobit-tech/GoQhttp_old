...
const (
	...
	SQL_GUID            = C.SQL_GUID
	SQL_BLOB            = C.SQL_VARBINARY
	SQL_CLOB            = C.SQL_LONGVARCHAR
	SQL_SIGNED_OFFSET   = C.SQL_SIGNED_OFFSET
	SQL_UNSIGNED_OFFSET = C.SQL_UNSIGNED_OFFSET
	SQL_DBCLOB          = C.SQL_LONGVARCHAR
	SQL_BOOLEAN         = C.SQL_BIT
	SQL_XML             = C.SQL_LONGVARCHAR
